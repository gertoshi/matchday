                ...
                {items.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            onClick={onNavigate}
                            className={`flex w-full items-center gap-4 rounded-2xl px-4 py-4 text-base font-semibold transition-all duration-200 ease-in-out ${
                                active
